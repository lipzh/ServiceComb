...
public class ConsumerHelloService {
  ...
  @RpcReference(microserviceName="helloprovider", schemaId="compute")
  Compute compute;
  ...
  public String hello(String name) {
    ...
    return "rpcCall:"+rpcCall + "; restTemplateCall:" + restTemplateCall;
  }
  ...
  @RequestMapping(method = RequestMethod.POST, path="compute")
  public String compute() {
	  int save = compute.add(100, 200);
